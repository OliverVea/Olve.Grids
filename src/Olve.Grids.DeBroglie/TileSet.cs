...
public class TileSet(IEnumerable<TileIndex> tileIndices)
{
    ...
    public OneOf<TileIndex, NotFound> GetTileIndex(Tile tiles)
    {
        return _tileIndexLookup.Get(tiles);
    }

    public OneOf<Tile, NotFound> GetTile(TileIndex tileIndex)
    {
        return _tileIndexLookup.Get(tileIndex);
    }
}